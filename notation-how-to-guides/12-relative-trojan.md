...
Every other Sagittal notation reads the staff relative to a chain of near-just Pythagorean fifths. The **12-Relative** notation does something different: it reads the staff relative to a chain of **12-EDO** fifths — the familiar 700¢ fifth.
...
The 12-Relative notation shines in two situations, both about **your performers**.

**Your tuning is neither JI nor a low EDO.** Say your pitches are proportioned by the golden ratio, or by some other scheme with no real connection to a chain of fifths and no good low-EDO approximation. If your players read staff notation as 12-EDO — as most classically trained musicians do — it makes no sense to ask them to re-interpret every nominal against some exotic fifth size. Keep their 12-EDO reading intact and let the sagittals supply the offsets.

**Your performers just want the offsets.** Even for a JI or EDO piece, players who are uneasy with alternative tuning may not want to learn new fifth sizes. The 12-Relative notation is a graceful alternative to scrawling cent deviations as little numbers on the page — you might need only two or three symbols to cover the whole piece, and they sight-read far better than a cloud of tiny numerals.

{% hint style="info" %}
Typical error under 12-Relative is only about **±2¢** — the amount the 12-EDO fifth strays from just. Serviceable for most ears, most of the time.
{% endhint %}
...
{% page-ref page="12-relative-binary-and-trinary.md" %}
